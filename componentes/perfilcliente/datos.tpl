<form role="form" method="POST" action="">
  <input type="hidden" name="prospecto_lead" value="1" />
    ...
    <div class="form-group col-md-6">
      <label for="celular_prospecto">Celular<span class="obligatorio">*</span></label>
    ...
    <div class="form-group col-md-12">
      <label for="web_prospecto">Web</label>
      <input type="text" class="form-control input-lg" id="web_prospecto" name="web_prospecto" placeholder="Web" value="{$datos.web_prospecto|default:''}">
    </div>
    <div class="form-group col-md-12">
