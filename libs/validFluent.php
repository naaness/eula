...
class ValidFluent
    ...
    private static $error_required = 'Este campo es requerido';
    private static $error_date = 'Por favor ingrese una fecha en fomato YYYY-MM-DD';
    private static $error_email = 'Por favor ingrese un email valido';
    private static $error_url = 'Por favor ingrese una url valida';
    private static $error_alfa = 'Solo letras y numeros son permitidos';
    private static $error_text = 'Solo letras son permitidos';
    private static $error_minSize = 'Por favor ingrese mas de %s caracteres';
    private static $error_maxSize = 'Por favor ingrese menos de %s caracteres';
    private static $error_numberFloat = 'Solo numero decimal permitido';
    private static $error_numberInteger = 'Solo numero entero permitido';
    private static $error_numberMax = 'Por favor ingrese un valor menos que %s ';
    private static $error_numberMin = 'Por favor ingrese un valor mas grande que %s ';
    private static $error_oneOf = 'Por favor escoja uno de " %s "';
    private static $error_equal = 'Campos no son iguales';
    private static $error_regex = 'Por favor escoja un valor valido';
