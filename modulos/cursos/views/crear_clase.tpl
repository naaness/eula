          ...
          <form name="form1" action="" method="post">
            ...
            <div class="box-body">
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="name" placeholder="Nombre de la clase" value="">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="btn-group btn-group-justified" role="group" aria-label="Justified button group">
                  {for $foo=1 to count($icono_tipo)}
                    <a class="btn btn-default {if $foo==1}active{/if}" role="button" id="tipo_{$foo}"><i class="{$icono_tipo[$foo]}"></i></a>
                  {/for}
                </div>
              </div>
