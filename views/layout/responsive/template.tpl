      ...
      <header id="header-contenido">
        ...
        <div class="wrap-header-contenido text-right">
          <div class="btn-group">
            ...
            {/if}
            {if $_acl->getId()==0}
              <a href="{$_layoutParams.root}login" class="btn btn-default">Entrar <span class="glyphicon glyphicon-log-out"></span></a>
            {else}
              ...
              <a href="{$_layoutParams.root}login/cerrar" class="btn btn-default">Salir<span class="glyphicon glyphicon-log-out"></span></a>
            {/if}
