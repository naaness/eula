    ...
    $.fn.ttwMusicPlayer = function(playlist, userOptions) {
        ...
        playlistMgr = function() {
            ...
            function playlistAdvance(index) {
                endTrackCallback(index, myPlaylist[index]);
            ...
            function playlistNext() {
                ...
                // runCallback(options.nextTrackCallback, index, myPlaylist[index]);
                // alert(options.nextTrackCallback);
                // funcion crada fuera de este plugin
